...
<div class="row mt-3">
    <div class="form-group col-md">
        ...
        <input type="text" class="form-control speciesInput autoCompleteInput" id="speciesInput${x}" name="speciesInput${x}" placeholder="Wpisz gatunek" >
        <div id="responsespeciesInput${x}"></div>
    </div>
    <div class="form-group col-md">
        <label for="locationInput0">Lokalizacja:</label>
        <input type="text" class="form-control locationInput autoCompleteInput" id="locationInput${x}" name="locationInput${x}">
        <div id="responselocationInput${x}"></div>
    </div>
    <div class="form-group col-md">
